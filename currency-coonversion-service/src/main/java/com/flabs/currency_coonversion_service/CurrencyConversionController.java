 ...
 * curl
 * http://localhost:8100/currency-conversion-feing/from/USD/to/INR/quantity/10
 */
@RestController
public class CurrencyConversionController {
         ...
         * -------------------------------------------------------
         * RestTemplate es el cliente HTTP clasico de Spring (anterior a
         * WebClient/Feign).
         * Requiere construccion manual de la URL, parametros y manejo del
         * ResponseEntity.
         *
         ...
         * --------------------------------------------------------
         * Feign es la forma recomendada de comunicacion entre microservicios en Spring
         * Cloud.
         *
         ...
         * Esto es comun en proyectos de aprendizaje. En produccion, sigue la convencion
         * REST:
